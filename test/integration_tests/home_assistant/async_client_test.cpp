...
//
////TODO (bielpa): Handle connection error when two clients connects with the same unique_id
////TODO (bielpa): Handle situation when client sends subscription message and then sends another one immediately
//
